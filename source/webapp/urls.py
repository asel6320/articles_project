...
from webapp.views import UpdateArticleView, DeleteArticleView, ArticleListView, CreateArticleView, \
    ArticleDetailView, CreateCommentView, UpdateCommentView, DeleteCommentView, toggle_like_article, toggle_like_comment
...
urlpatterns = [
    ...
    path('article/<int:pk>/toggle-like/', toggle_like_article, name='toggle_like_article'),
